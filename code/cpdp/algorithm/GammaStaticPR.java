...
public class GammaStaticPR implements Algorithm<CPDPInstance, CPDPSolution> {
    ...
    public GammaStaticPR(Constructive<CPDPInstance, CPDPSolution> c, Improvement<CPDPSolution> ls, int populationSize, int refsetSize, float prTypeThreshold) {
        this.c = c;
        this.ls = ls;
    ...
    public String toString() {
        return this.getClass().getSimpleName()+"(" + c +", " + ls + ", " + refsetSize + "," +prTypeThreshold+ ")";
    }
}
