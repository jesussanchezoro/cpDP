...
public class ParallelDeltaStaticPR implements Algorithm<CPDPInstance, CPDPSolution> {
    ...
    public ParallelDeltaStaticPR(Constructive<CPDPInstance, CPDPSolution> c, Improvement<CPDPSolution> ls, int populationSize, int refsetSize) {
        this.c = c;
        this.ls = ls;
